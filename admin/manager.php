								...
								<tr>
									...
									<td class="text-center" <?php if( isset($_SESSION['manager']) AND $_SESSION['manager'] != $email){echo "colspan='2'";} ?>>
										<?php 
											if( isset($_SESSION['admin'])){
												?>
												<a href="<?php echo SITEURL; ?>/admin/admin-update.php?id=<?php echo $id; ?>&&bt=ep" class="btn-warning">Edit</a>
									</td>
									<td class="text-center">
												<a href="<?php echo SITEURL; ?>/admin/admin-delete.php?id=<?php echo $id; ?>&&bt=ep" class="btn-danger" onclick="return confirm('Are you sure...?');">Delete</a>
									</td>
									<td class="text-center">
												<?php
											}
									...
									<td class="text-center">
												<a href="<?php echo SITEURL; ?>/admin/admin-pwd-update.php?id=<?php echo $id; ?>&&bt=ep" class="btn-success">Change Password</a>
												<?php
											}
										?>
									</td>
